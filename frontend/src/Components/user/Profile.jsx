            ...
            <div className="divide-y divide-gray-200">
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-gray-800 text-xl">{user.username}</p>
                </div>
                ...
                <button
                  onClick={handleLogout}
                  className="w-full bg-red-500 text-white py-3 px-4 rounded-lg hover:bg-red-600 transition duration-200 mt-6"
                >
                  Logout
                </button>
              </div>
